...
import com.fajaradisetyawan.githubuser.db.DatabaseContract.UserColum.Companion._ID
...
class GithubHelper(context: Context) {
    companion object{
        ...
        fun getInstance(context: Context): GithubHelper = INSTANCE ?: synchronized(this){
