package com.fajaradisetyawan.githubuser.notification
...
import com.fajaradisetyawan.githubuser.view.activity.SplashScreenActivity
import java.util.*
...
class AlarmReceiver : BroadcastReceiver() {
    companion object{
        ...
        const val CHANNEL_NAME = "Alarm Manager Chanel"
    }
    ...
    private fun showAlarmNotification(context: Context){
        ...
        val builder = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setContentTitle(context.resources.getString(R.string.notification_text))
